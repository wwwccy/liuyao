...
let benYao_g      = [];
let lastCastGua     = null;
let lastCastBianGua = null;
...
function doCast() {
  ...
  // 通知 AI 和历史模块
  if (typeof onCastComplete === 'function') onCastComplete(benGua, bianGua, sz);
  if (typeof saveReading    === 'function') saveReading(benGua.name, bianGua.name, sz);
}
